...
//    for. `qa/T-68/case-02-principle-22-content.mjs` is the case that
...
//    times (`qa/gaps.md` item 21). The per-line count is printed beside
...
// `qa/T-67/case-03-no-principles-by-number.mjs` bans the name-first shape
...
// wider in direction: both word orders, because `qa/gaps.md` item 29 is
...
// false red later (`qa/gaps.md` item 31). What is required is the SHAPE of a
...
//
// The self-test below covers both matchers, for the reason `qa/gaps.md`
...
check(
  ...
  `${numberFirst.length} pointer(s):\n      ${numberFirst.join("\n      ")}\n      this is the word order that walked past four pins written to ban this rule (qa/gaps.md item 29)`,
);
