...
// it sits right there. `qa/gaps.md` items 21, 28 and 30 are the three traps,
...
// `qa/T-64/case-03-every-change-gets-a-milestone.mjs` already pins the two
...
// different capitalisation — the two ways `qa/gaps.md` items 28 and 30 say a
