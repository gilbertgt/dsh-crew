...
// `qa/T-60/case-09-prd-and-hld-exist-now.mjs` closes in its own header
...
// count.
//
// THE WRAPPING TRAP, LIVE IN THIS VERY SECTION. `qa/gaps.md` item 21 and
...
//     pinned by `qa/T-52/case-01` and `case-02`. A pin demanding a number
...
//     `qa/T-52/case-09-glossary-placement.mjs` already pins the ordering.
...
//     themselves is nobody's, and `qa/gaps.md` is where that stays written.
//
...
// `qa/gaps.md` item 21, the `crew-qa-C42` note: an assertion that only
