...
// the precedent). That belongs in `qa/gaps.md`, not in a checker here.
//
...
//      (`qa/gaps.md` item 21). Everything read here is a table row.
...
//      `qa/T-60/case-09-prd-and-hld-exist-now.mjs` closes the same hole:
