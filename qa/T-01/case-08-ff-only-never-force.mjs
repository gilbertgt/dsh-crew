...
// were left judging the rule that had been superseded -- `qa/gaps.md` item
...
// (`qa/gaps.md` items 21 and 30). The present halves are phrase families:
...
// `qa/T-66/case-04-no-force-push-permission.mjs` slices the merge and the
// push paragraphs apart and prints four counts per absent wording, and
// `qa/T-94/case-01-force-push-needs-user-approval.mjs` checks the four
// parts of the new rule per place. The overlap between the three is the overlap
// `qa/gaps.md` item 3 describes: the check names the strings, so the inputs
