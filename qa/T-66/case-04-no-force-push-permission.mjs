...
// `qa/gaps.md` item 33: a superseded check does not retire itself, it is
...
// `qa/T-94/case-01-force-push-needs-user-approval.mjs`, so the two cases
...
//    `qa/T-01/case-08-ff-only-never-force.mjs` (turned around on the same
...
//    flattening (`qa/gaps.md` item 21). Both mutants below put the
...
//
// 4. MENTION AGAINST RULE (`qa/gaps.md` item 26), and this is the reason
...
// (`qa/gaps.md` item 21: for an absent pin the per-line 0 proves nothing)
// or with one capital letter changed (`qa/gaps.md` item 30). The present
