...
//
// The shape is borrowed from `qa/T-60/case-09-prd-and-hld-exist-now.mjs`,
...
// that bit this job eight times (`qa/gaps.md` item 21). The counts printed
...
// (`qa/gaps.md` item 27: an anchor quoted from a document may be the
