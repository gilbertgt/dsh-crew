...
//     line wrap had split in two (`qa/gaps.md` item 21). The `Corrections`
...
//   removes. That gap belongs in `qa/gaps.md`, not in a green tick here.
//
