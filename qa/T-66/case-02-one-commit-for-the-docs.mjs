...
// rendering can be dead from the moment it is written (`qa/gaps.md` item 27).
...
// compared, exactly as `qa/gaps.md` item 21 asks. The printed table shows the
...
check(
  ...
  `not found in step 13 — check the file's own bytes before changing this anchor (qa/gaps.md item 27)`,
);
