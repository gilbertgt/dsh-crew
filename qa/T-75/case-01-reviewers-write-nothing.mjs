...
// (`ADR 0023`, and `qa/gaps.md` items 21, 27, 28 and 31):
//
...
// would understand it — `qa/gaps.md` items 1 and 2. It holds the floor:
...
// false — and no existing check would notice: `qa/T-63/case-07` compares
...
// few reads in this repository where that is safe (`qa/gaps.md` item 21).
