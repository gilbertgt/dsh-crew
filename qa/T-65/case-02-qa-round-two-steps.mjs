...
// `qa/T-65/case-01-reviews-once-at-the-end.mjs`.
...
check(
  "step two's output is a real test file under qa/<task-id>/ with a run.sh beside it",
  /real test file/.test(plainC) && /qa\/<task-id>\//.test(plainC) && /run\.sh beside it/.test(plainC),
