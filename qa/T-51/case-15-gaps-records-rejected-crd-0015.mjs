...
// were rejected by the user, so both are recorded in `qa/gaps.md` instead of
// being fixed.
//
...
check("qa/gaps.md records the allow-list shell hole", hole !== "", "the hole CRD 0015 named is not in the gap list");
...
check("qa/gaps.md records the missing CLAUDE.md step", step !== "", "ADR 0010's step is not in the gap list");
