// T-51, DoD item 18: the comment above the `qa/gaps.md` count pin says FOUR
...
check("the comment says `qa/gaps.md` appears FOUR times", start !== -1, "the count in the comment is not four");
...
check(
  ...
  mount.includes('copiesOf(section.text, "qa/gaps.md") < 3'),
