// T-51, DoD item 17: `qa/gaps.md` records that the shell check still does
...
check("qa/gaps.md names crew_qa", gaps.includes("crew_qa"), "the gap is not recorded at all");
