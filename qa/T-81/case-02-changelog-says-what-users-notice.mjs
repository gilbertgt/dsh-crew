...
// assertion or to edit the history (`qa/gaps.md` item 31). The section has
...
// "the parts of the phrase are still there" trap of `qa/gaps.md` item 3: it
...
// habit `qa/gaps.md` item 27 asks for, used here for the opposite reason:
