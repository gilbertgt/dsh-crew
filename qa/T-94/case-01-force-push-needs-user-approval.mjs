...
// PM that read the sentence actually goes and asks; see `qa/gaps.md`.
//
...
//    time somebody rewords the passage legitimately, and `qa/gaps.md` item
...
//    `qa/gaps.md` item 26 measured that trade for the mention-versus-rule
...
//    `qa/gaps.md` item 21). Case is dropped for the same class of reason
//    (`qa/gaps.md` item 30): a wording that opens a sentence is
...
//        `qa/T-66/case-04-no-force-push-permission.mjs`'s job on the
//        source file.
//
 ...
 * WITHOUT case (`qa/gaps.md` item 30, and mutant 5 below found the first
...
// file -- the false red one level up (`qa/gaps.md` item 21).
//
