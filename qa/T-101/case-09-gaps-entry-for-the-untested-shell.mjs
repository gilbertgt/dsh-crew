// M1 DoD item 5: qa/gaps.md carries the hole this milestone knowingly
...
//
// qa/gaps.md is the PM's file. QA never writes it; QA reports the lines and
...
// gaps.md that is perfectly correct. qa/lib/qa.mjs walks fences the same
