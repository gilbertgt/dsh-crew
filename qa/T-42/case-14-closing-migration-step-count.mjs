...
const two = tempRepo();
try {
  const held = keepCopies(two, "roles/pm.md", PATH, 2, "qa/somewhere-else.md");
...
const one = tempRepo();
try {
  keepCopies(one, "roles/pm.md", PATH, 1, "qa/somewhere-else.md");
...
try {
  keepCopies(three, "roles/pm.md", PATH, 3, "qa/somewhere-else.md");
