...
// When `qa/T-60/case-09` was moved off the two fixed paths and onto a
...
//
// AND `qa/gaps.md` item 21: every prose read here is FLATTENED first. The
...
// claiming anything about `roles/pm.md` — `qa/gaps.md` item 21, the
