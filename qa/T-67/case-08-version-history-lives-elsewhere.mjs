...
//      (`qa/gaps.md` item 21 — the trap that bit this job seven times);
...
//
// `qa/gaps.md` ITEM 27, HANDLED. The anchor the DoD hands over is `Applied`
...
// two lines above it, not a claim about `roles/pm.md` — `qa/gaps.md` item 21,
