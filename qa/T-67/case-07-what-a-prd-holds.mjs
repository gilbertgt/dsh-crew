...
//
// THE DIVISION OF LABOUR WITH `qa/T-63/case-09-eight-document-types.mjs`.
...
// two DoD halves, the "target window" clause. `qa/gaps.md` item 21 is this
...
// never go green, which is `qa/gaps.md` item 27 in the other direction. So the
...
//     read a PDF and judge that; `qa/gaps.md` keeps it written down.
//
