...
//     insensitive) are printed. `qa/gaps.md` item 21 second note: for an
...
//     ever on a correct file, which is `qa/gaps.md` item 31's failure mode
...
// — that is exactly the pressure `qa/gaps.md` item 33 describes, and giving
