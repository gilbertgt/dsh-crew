...
//      the DoD wording (`qa/gaps.md` items 27 and 31). Note what that
...
// fail (`qa/gaps.md` items 21 and 28). What can really break is the far
...
// record does not turn this red (`qa/gaps.md` item 26, second note).
check(
