...
// written somewhere else (`qa/gaps.md` item 26). So the slice is built
...
// spent finding (`qa/gaps.md` items 16, 28). So both directions are pinned:
...
// "not there" for a sentence that is there (`qa/gaps.md` item 21, which
...
// from the DoD cell as rendered. `qa/gaps.md` items 27 and 31 are the two
...
// The file is read through `repoFile()`, whose root is `qa/lib/qa.mjs` up
// two levels. Nothing outside the process can move that. An earlier version of
...
// `tempRepo()` in `qa/lib/qa.mjs` copies neither `principles.md` nor
// `qa/lib/`, so the shared mutation helpers cannot reach this file. The
...
//   <throwaway>/qa/lib/qa.mjs
//   <throwaway>/qa/T-68/case-02-principle-22-content.mjs
//
...
// `qa/gaps.md` items 13 and 16 are both about.
check(
