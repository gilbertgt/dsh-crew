...
//
//   - `qa/T-81/case-01-changelog-order.mjs` goes RED when the top section is
...
check(
  ...
  `the top section is marked unreleased AND names ${version}, the version package.json already holds`
    + " — that is the exact state qa/T-81/case-01 turns red on, and it breaks the release run",
);
