// T-52, DoD item 18: `qa/gaps.md` records that no check can prove the
...
// carried. `ADR 0014` asks for it in as many words ("这一条要进 qa/gaps.md",
// 验法: `grep -n 'ADR 0014' qa/gaps.md`), and it says why: the last
...
//
// The work is QA's: `qa/` is QA's home and no engineer may write there, so
...
const gaps = repoFile("qa/gaps.md");

check(
  "qa/gaps.md names ADR 0014",
