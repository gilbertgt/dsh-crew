...
// acceptance cases in `qa/` after the code is finished. The PRD calls the
...
check(
  "home: the project's own test suite against `qa/<task-id>/`",
  /project's own test suite/i.test(home[1] ?? "") && /qa\//.test(home[3] ?? ""),
