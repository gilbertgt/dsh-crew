...
// (`docs/qa/T-67/case-09` uses the same device, and gaps item 24 explains why
...
// `docs/qa/T-59/case-09`'s job, and T-59 was deleted with the README shrink.
// This case checks only that the two READMEs agree with each other;
// `package.json` consistency is `docs/qa/T-110/case-03`'s business.
//
